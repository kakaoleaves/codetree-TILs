...
|총 문제 수|티어|유형|
|---:|---|---|
|3|![Platinum5][p5] ~ ![Platinum3][p3]|`Doubly-LinkedList` `Simulation` `HashSet` `Sort` `HashMap`|

|기록분류|이름|티어|유형|상태|최근 제출 코드|
|---|---|---|---|---|---|
|기출문제|[코드트리 오마카세](https://www.codetree.ai/training-field/frequent-problems/problems/codetree-omakase)|![Platinum3][p3]|`Simulation` `Sort` `HashMap` `HashSet`|![Passed][passed]|[링크](https://github.com/kakaoleaves/codetree-TILs/blob/main/240411/%EC%BD%94%EB%93%9C%ED%8A%B8%EB%A6%AC%20%EC%98%A4%EB%A7%88%EC%B9%B4%EC%84%B8/codetree-omakase.cpp)|
